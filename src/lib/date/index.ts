...
export const getDateFormat = (date: Date, formatStr: string = 'YYYY-MM-DD'): moment => {
...
export const getAusTimestamp = (date: number, formatStr: string = 'YYYY-MM-DD HH:mm:ss'): string => {
  return date
    ? moment(date)
        .tz('Australia/Sydney')
        .format(formatStr)
